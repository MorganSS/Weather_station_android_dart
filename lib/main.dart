...
class _MyHomePageState extends State<MyHomePage> {
  String broker = 'm9.wqtt.ru';
  int port = 12146;
  String clientIdentifier = 'colledge';
  ...
  void _connect() async {
    ...
    //_subscribeToTopic("kws/sensorKws1");
   // _subscribeToTopic("kws/sensorKws2");
  ...
  void _onMessage(List<mqtt.MqttReceivedMessage> event) {
    ...
    setState(() {
      ...
      _airpVal = int.parse(receiveData[2]);
      _altiVal = int.parse(receiveData[3]);
    });
  }
}
